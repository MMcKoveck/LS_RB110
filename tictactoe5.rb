...
def check_for_tie(remaining_moves)
...
def display_winning_line(hashes, moves)
  symbols = (:a..:i).to_a
  character_array = ['-', '|', '\\', '/']
  # value_array_key = [starting_square, square_increment, starting_symbol_index,
...
def choose_either_opponent_dialog(name_choice, name_array)
...
# INSTRUCTION LOOP   # needs board_hash (can set_board in method for board_hash)
loop do
  system 'clear'
...
# OUTRO         # NEEDS total_wins_hash, user_name
system "clear"
double_space
